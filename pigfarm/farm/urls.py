...
urlpatterns = [
    ...
    path('feeding-records/add/', add_feeding_record, name='add_feeding_record'),
    path('feeding-records/<uuid:record_id>/edit/', add_feeding_record, name='edit_feeding_record'),
    path('feeding-records/<uuid:record_id>/delete/', delete_feeding_record, name='delete_feeding_record'),
