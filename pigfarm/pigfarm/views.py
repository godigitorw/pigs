...
def dashboard_view(request):
    try:
        logger.info("Starting dashboard_view calculation")
        ...
        logger.info(f"Counts calculated: sows={total_sows}, piglets={total_piglets}")
        ...
        for record in feed_records:
            ...
            cost_data.append(float(record['total_cost'] or 0)) 
            quantity_data.append(float(record['total_quantity'] or 0))
            
        total_feed_cost = sum(cost_data)
        logger.info("Feed records processed")
        ...
        logger.info("Weight records processed")
        ...
        logger.info("Financials calculated")
        ...
        logger.info("Dashboard context ready, rendering template")
        ...
        # In DEBUG mode, Django shows the error. In production, we get 500.
        # This forces the error to be shown even in production (Render)
        error_html = f"""
        <html>
            ...
            <body style="font-family: monospace; padding: 20px;">
                ...
                <h3>Traceback:</h3>
                <pre style="background: #eee; padding: 15px; overflow: auto;">{traceback.format_exc()}</pre>
            </body>
        </html>
        """
